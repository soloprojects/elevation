...
class CompaniesController extends Controller
{
    ...
    {
        //
        $userDetail = Employees::firstRow('user_id',Auth::user()->id);
        $Company = Companies::firstRow('id',$userDetail->company_id);
        
        return view::make('Companies.detail')->with('data',$Company);
